...
namespace cpms_Infrastructure.Migrations
{
    ...
    [Migration("20260918225722_IssueTimeMaterialBudgetLedger")]
    partial class IssueTimeMaterialBudgetLedger
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("cpms_Domain.Ledger.ProjectBudgetLedger", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MaterialRequestId", "RecordedAt");

                    b.HasIndex("ProjectId", "RecordedAt");

                    b.ToTable("ProjectBudgetLedgers", null, t =>
                        {
                            t.HasCheckConstraint("CK_ProjectBudgetLedgers_ActualCost", "[ActualCost] >= 0");

                            t.HasCheckConstraint("CK_ProjectBudgetLedgers_EntryType", "[EntryType] IN ('ISSUE','CORRECTION','RETURN')");
                        });
                });
            ...
            modelBuilder.Entity("cpms_Domain.Models.MaterialRequest", b =>
                {
                    ...
                    b.HasIndex("ActualCostUpdatedByUserId");
            ...
            modelBuilder.Entity("cpms_Domain.Models.Phase", b =>
                {
            ...
            modelBuilder.Entity("cpms_Domain.Models.MaterialRequest", b =>
                {
                    b.HasOne("cpms_Domain.Models.UserAccount", null)
                        .WithMany()
                        .HasForeignKey("ActualCostUpdatedByUserId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("cpms_Domain.Models.TaskItem", b =>
                {
                    ...
                    b.HasOne("cpms_Domain.Models.Phase", "Phase")
                        .WithMany("Tasks")
